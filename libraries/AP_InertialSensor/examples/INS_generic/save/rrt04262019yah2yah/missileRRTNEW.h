...
double const tofmax    = 3.0;
double const tmax      = 3.5;   // time to stop execution loop
double const tSrm      = 1.0; //0.5; ///0.050; // don't fire
double const durSrm    = 0.5;   // duration of ignition pulse
double const tPara     = 3.0; //1.5;     // time to eject parachute
double const durPara   = 0.5;   // duration of parachture squib pulse
//int    const toneQty   = 16; // total acs tone pulses lab test
int    const toneQty   = 16; // total acs tone pulses flight test, 0.2 sec
