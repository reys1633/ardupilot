...
//double const tofmax    = 2.0; // 3.0;
double const tmax      = 0.5; //2.5;   // time to stop execution loop
double const tSrm      = 0.25; //0.5; ///0.050; // don't fire
double const durSrm    = 0.5+0.5; // duration of ignition pulse
double const tPara     = 1.75; //1.5;     // time to eject parachute
...
int    const chargdelay= 150; //15000
