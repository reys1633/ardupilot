...
//double const tofmax    = 2.5; //5.0; //10.0; //3.0; // 3.0;
double const tSrm      = 0.25; //0.5; ///0.050; // don't fire
double const durSrm    = 0.25; // duration of ignition pulse
//double const tPara     = 1.5; //2.5; //1.75; //1.5;     // time to eject parachute
double const durPara   = 0.25; // duration of parachture squib pulse
//int    const toneQty   = 16; // total acs tone pulses lab test
int    const toneQty   = 64
; // 64; // total acs tone pulses flight test, 0.2 sec
int    const chargdelay= 3000; //150; //15000

#define FLIGHTTEST true
#if FLIGHTTEST
double const tmax      = 3.0; //15.0; //3.0;   // time to stop execution loop
double const tofmax    = 2.5; //10.0; //2.5; // 3.0;
double const tPara     = 1.5; //2.5; //1.75; //1.5;     // time to eject parachute
#else //if !BENCHTEST
double const tmax      = 6.0; //15.0; //3.0;   // time to stop execution loop
double const tofmax    = 5.0; //10.0; //2.5; // 3.0;
double const tPara     = 1.5; //2.5; //1.75; //1.5;     // time to eject parachute
#endif
